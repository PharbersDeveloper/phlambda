...
const awsLambdaTemplate_1 = __importDefault(require("../httpStrategies/awsLambdaTemplate"));
...
class AppLambdaDelegate {
    ...
    connect2MongoDB() {
        ...
        if (auth) {
            ...
            mongoose.connect(prefix + "://" + username + ":" + pwd + "@" + host + ":" + port + "/" + coll + "?authSource=" + authSource, { useNewUrlParser: true, autoReconnect: true }, (err) => {
                if (err != null) {
    ...
    generateRoutes(registry) {
        ...
        this.httpStrategies = new awsLambdaTemplate_1.default(new json_api_1.default.controllers.API(registry, opts), new json_api_1.default.controllers.Documentation(registry, { name: "Pharbers API" }));
    }
}
