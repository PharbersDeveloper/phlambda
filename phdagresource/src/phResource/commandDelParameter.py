...
class CommandDelParameter(Command):
    ...
    def update_parameter(self):
        ...
        userIp_value = self.ssm.get_ssm_parameter("userIp")
        userIp_value.pop(self.project_id)
        self.ssm.put_ssm_parameter("userIp", json.dumps(userIp_value))

        # 获取 project_args
        project_args_value = self.ssm.get_ssm_parameter("projects_args")
        project_args_value.pop(self.project_id)
        ...
        project_diver_args.pop(self.project_id)
        ...
        project_diver_args.pop(self.project_id)
        self.ssm.put_ssm_parameter("airflow_args", json.dumps(project_diver_args))
