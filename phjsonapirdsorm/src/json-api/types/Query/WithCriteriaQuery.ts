...
import { AndExpression, FieldExpression } from "../index"
...
export default class WithCriteriaQuery extends Query {
   ...
   */
  public andWhere(constraint: FieldExpression) {
   ...
   */
  public matchingIdOrIds(idOrIds: string | string[] | undefined): this {
    let res
  ...
  public getFilters(): AndExpression {
   ...
   */
  public isSimpleIdQuery(): boolean {
  ...
  public withLimit(limit: number | undefined) {
    const res = this.clone()
