...
import Relationship, { RelationshipArgs, RelationshipJSON } from "./Relationship"
...
export default class Resource {
  ...
  public equals(otherResource: Resource) {
    return this.id === otherResource.id && this.type === otherResource.type
  }

  public removeAttr(attrPath: string) {
    if (this._attrs) {
      deleteNested(attrPath, this._attrs)
    }
  }

  public removeRelationship(relationshipPath: string) {
    if (this._relationships) {
      deleteNested(relationshipPath, this._relationships)
    }
  }

  public setRelationship(relationshipPath: string, data: RelationshipArgs["data"]) {
  ...
  public toJSON(urlTemplates: UrlTemplates): ResourceJSON {
