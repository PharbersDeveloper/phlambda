...
default_args = {
    ...
    "projectId": "hbzhao_test_projectId"
}

dag = DAG(
    dag_id="max_hbzhao_test_dag_developer",
    tags=['default'],
...
############## == max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV == ###################
def max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV_cmd(**context):

    id = generate()
    dag_name = "max_hbzhao_test_dag_developer"
    job_full_name = "max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV"
    job_show_name = "test_job_a"
...
max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV = PythonOperator(
    task_id='max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV',
    provide_context=True,
    python_callable=max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV_cmd,
    dag=dag
)
############## == max_hbzhao_test_dag_developer_test_job_a_f_ELa9mxRqokPgV == ###################
