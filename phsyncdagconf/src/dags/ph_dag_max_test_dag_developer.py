...
############## == max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ == ###################
def max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ_cmd(**context):

    id = generate()
    dag_name = "max_test_dag_developer"
    job_full_name = "max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ"
...
max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ = PythonOperator(
    task_id='max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ',
    provide_context=True,
    python_callable=max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ_cmd,
    dag=dag
)
############## == max_test_dag_developer_test_job_a_FRGlSp7yWqKAleJ == ###################
