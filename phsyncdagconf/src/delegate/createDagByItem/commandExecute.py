...
def max_script(dag_item):
    ...
    try:
        ...
        logging.info("创建dag的level成功")
        logging.info(dag_item_level_list)
    except Exception as e:
    ...
    try:
        ...
        logging.info("根据level创建dag_item成功")
        logging.info(dag_item_list)
    except Exception as e:
    ...
    try:
        ...
        logging.info("将创建好的dag_item上传到dynamodb成功")
    except Exception as e:
